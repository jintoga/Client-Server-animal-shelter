 ...
 */
public class CustomAdapterGridview2 extends BaseAdapter implements Filterable {
    ...
    public CustomAdapterGridview2(Context context, int resource, ArrayList<Animal> listAnimal) {
